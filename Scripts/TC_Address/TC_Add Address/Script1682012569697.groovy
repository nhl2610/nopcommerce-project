...
if (id == '4') {
    ...
    expected = WebUI.getText(findTestObject('Object Repository/Page_Account Address/li_InfoEmail'))

    assert expected.contains(email) == true

    expected = WebUI.getText(findTestObject('Object Repository/Page_Account Address/li_InfoPhone'))

    assert expected.contains(phone) == true

    expected = WebUI.getText(findTestObject('Object Repository/Page_Account Address/li_InfoAddress1'))
